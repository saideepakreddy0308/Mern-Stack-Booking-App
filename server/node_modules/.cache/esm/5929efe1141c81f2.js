let User,Stripe,queryString,Hotel,Order;_141‍.x([["createConnectAccount",()=>createConnectAccount],["getAccountStatus",()=>getAccountStatus],["getAccountBalance",()=>getAccountBalance],["payoutSetting",()=>payoutSetting],["stripeSessionId",()=>stripeSessionId],["stripeSuccess",()=>stripeSuccess]]);_141‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_141‍.w("stripe",[["default",["Stripe"],function(v){Stripe=v}]]);_141‍.w("query-string",[["default",["queryString"],function(v){queryString=v}]]);_141‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_141‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);
...
const stripe = Stripe(process.env.STRIPE_SECRET);
  ...
  _141‍.g.console.log("LOGIN LINK", link);
  res.send(link);
...
const updateDelayDays = async (accountId) => {
  ...
  try {
    ...
    _141‍.g.console.log("STRIPE PAYOUT SETTING ERR ", err);
  }
};
  ...
  try {
    ...
    _141‍.g.console.log("STRIPE SUCCESS ERR", err);
  }
};
